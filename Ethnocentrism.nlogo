...
to-report cc-sum
  report count turtles with [shape = "circle"]
end
to-report cd-sum
  report count turtles with [shape = "circle 2"]
end
to-report dd-sum
  report count turtles with [shape = "square 2"]  
end
to-report dc-sum
  report count turtles with [shape = "square"]
end
to-report reach-limit [limit]
  ifelse ticks >= limit
  [ report true ]
  [ report false ]
end 
